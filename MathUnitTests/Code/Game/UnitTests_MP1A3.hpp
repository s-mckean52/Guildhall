...
#define AABB2_Maxs							maxes		// e.g. "maxs" if your AABB2 is used as "myBox.maxs"
...
#define Function_ClampFloat					GetClamp
#define Function_ClampFloatZeroToOne		GetClampZeroToOne
